...
public interface IFactory<out TObject, in TValue1, in TValue2, in TValue3, in TValue4>
{
    /// <summary>
    /// Create new instance
    /// </summary>
    ...
    static abstract TObject Create(TValue1 value1, TValue2 value2, TValue3 value3, TValue4 value4);
}